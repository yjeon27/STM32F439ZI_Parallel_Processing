...
{
  HAL_GPIO_WritePin(SD_CS_GPIO_Port, SD_CS_Pin, GPIO_PIN_RESET);	// PE4 (pin 4 of port E has been selected as SD_CS in .ioc)
}

/* SPI Chip Deselect */
static void DESELECT(void)
{
  HAL_GPIO_WritePin(SD_CS_GPIO_Port, SD_CS_Pin, GPIO_PIN_SET); // PE4 (pin 4 of port E has been selected as SD_CS in .ioc)
}
